...
Backend-сервис обработки платежей, реализованный на **FastAPI**, **SQLAlchemy 2.0 Async**, **PostgreSQL** и **RabbitMQ**
с использованием **Outbox Pattern**, поддержкой **Idempotency-Key**, webhook-уведомлений, retry-механизма и DLQ.
...
Это гарантирует отсутствие потери событий.
